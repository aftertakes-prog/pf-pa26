...
export default function YoutubePlaylist({ playlistId, onVideoSelect, videos, playlistTitle = 'Sonet X-Line', channelName = 'Kia India', sidebarGradient = SONET_GRADIENT }: Props) {
